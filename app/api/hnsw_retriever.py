...
-- Add HNSW index on the documents table
-- Adjust table/column names to match your schema
-- Common column names: embedding, vector, chunk_embedding
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_docs_hnsw
    ON documents
    USING hnsw (embedding vector_cosine_ops)
    WITH (m = 16, ef_construction = 64);

-- For the chunks table if separate
...
HNSW_CONFIG = {
    ...
    "text_column": "text",
    "title_column": "page_or_section",
    "metadata_columns": ["evidence_level", "chunk_index"],
}
