...
from app.api.visual_store import delete_visual as _vs_delete_visual
...
def delete_visual(visual_id: str) -> DeleteResponse:
    ...
    """
    deleted = _vs_delete_visual(visual_id)
    logger.info(f"[VisualDelete] delete_visual({visual_id}) → deleted={deleted}")
