 ...
 * Route: /complications  (add to App.tsx)
 *
 * Drop-in replacement for the stub component.
 * Calls:
 ...
 *
 * The shared component in the document hits /api/safety/v2/protocol — that
 * endpoint does not exist. This file uses the correct routes.
 */
...
// ─── Protocol result section wrapper ────────────────────────────────────────
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 space-y-5">
        ...
        {result && severityStyle && urgencyInfo && (
          <div ref={resultsRef} className="space-y-4">
            ...
            {/* Red flags — always open, always prominent */}
