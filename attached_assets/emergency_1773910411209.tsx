/**
 * AesthetiCite — Emergency Protocol Page
 * ========================================
 * Drop into: client/src/pages/emergency.tsx
 * Route: /emergency (add to App.tsx)
 *
 * Dedicated emergency entry point — accessible from everywhere.
 * Big red buttons, immediate protocol access, no friction.
 * Reads ?protocol=vascular_occlusion from URL for direct deep-linking.
 */
          ...
          <div className="flex items-center gap-3">
            ...
            {timerActive && (
              <div className="flex items-center gap-1.5 bg-red-900/60 rounded-lg px-3 py-1.5">
                ...
                <span className="text-sm font-mono font-bold text-red-300">{formatTime(elapsedSeconds)}</span>
              </div>
            )}
            {protocol && (
              <button
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          {protocol && !protocolMutation.isPending && (
            <>
              ...
              {/* Red flags + escalation — side by side */}
