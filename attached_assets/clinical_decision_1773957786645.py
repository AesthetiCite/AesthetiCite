...
# Keyword matching to workflow keys
...
def calc_hyaluronidase(
    ...
    if is_vascular_occlusion:
        # Vascular occlusion: always minimum 1500 IU regardless of region
...
async def master_decision(
    ...
    # Build all blocks (all synchronous — fast)
    ...
    # Hyaluronidase suggestion if applicable
    ...
    # Evidence — try to fetch from existing RAG; return mock if unavailable
