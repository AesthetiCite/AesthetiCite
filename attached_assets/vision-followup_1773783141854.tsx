 ...
 *
 * Route: /vision-followup  (add to App.tsx)
 *
 ...
 *   </Route>
 *
 * Add to routes.ts (alongside existing visual counseling routes):
 *   app.all(["/api/vision", "/api/vision/*splat"], (req: Request, res: Response) => {
 *     proxyToFastAPI(req, res, req.path);
 *   });
 *
 * Add to sidebar-safety-nav.tsx or the mobile Sheet nav as a new Clinical Tools entry.
 */
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-6">
          ...
          <div className="space-y-4">
            ...
            {result && uc && (
              <>
                {/* Urgency banner */}
                <div className={`rounded-xl border-2 p-5 ${uc.bg}`}>
                ...
                {/* Concerns — always prominent when present */}
