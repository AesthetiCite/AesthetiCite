/**
 * SIDEBAR SAFETY NAV SECTION
 * ─────────────────────────────────────────────────────────────────────
 * File: client/src/components/sidebar-safety-nav.tsx
 *
 * Drop this component into ask.tsx inside the <aside> sidebar,
 * immediately after the search filter Input and tag bar,
 * and before the <ScrollArea> conversation list.
 *
 * In ask.tsx, find:
 ...
 *   <SidebarSafetyNav />
 *
 * Also add to the ask.tsx imports:
 *   import { SidebarSafetyNav } from "@/components/sidebar-safety-nav";
 *
 * Also add these two items to the existing More dropdown in the header:
 ...
 *   </DropdownMenuItem>
 *
 * And in the mobile Sheet nav under "Safety & Tools":
 *   <Link href="/complications" className="flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-muted transition-colors">
 *     <AlertTriangle className="h-4 w-4" />Complication Protocols
 *   </Link>
 */
