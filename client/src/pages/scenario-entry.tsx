...
type Scenario = "emergency" | "before" | "question" | "visual";
...
const SCENARIOS: ScenarioOption[] = [
  ...
  },
  {
    ...
    sublabel: "Photo-based assessment",
    description: "Upload a clinical photo and get a structured complication assessment with ranked causes.",
    examples: [
      "Post-filler blanching or colour change",
      "Suspected vascular occlusion — photo triage",
      "Compare healing across two appointments",
      "Erythema, oedema, asymmetry assessment",
    ],
...
function StatPill({ value, label, delay }: { value: string; label: string; delay: number }) {
  ...
  return (
    ...
    >
      ...
      <span style={{ fontSize: "11px", color: "#6B7280", fontFamily: "'DM Sans', sans-serif", letterSpacing: "0.04em", textTransform: "uppercase" as const }}>
        {label}
      </span>
    </div>
  );
    ...
    >
      ...
      <div style={{ marginTop: "auto" }}>
        ...
        >
          ...
          >
            {scenario.id === "emergency" ? "Open protocol" : scenario.id === "before" ? "Run safety check" : scenario.id === "visual" ? "Analyse photo" : "Ask a question"}
          </span>
          <svg
            width="14"
            height="14"
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        @media (max-width: 900px) {
          .scenario-grid { flex-wrap: wrap !important; }
          .scenario-grid > * { min-width: calc(50% - 8px) !important; flex: 0 0 calc(50% - 8px) !important; }
        }
        @media (max-width: 520px) {
          .scenario-grid { flex-direction: column !important; flex-wrap: nowrap !important; }
          .scenario-grid > * { min-width: unset !important; flex: 1 1 auto !important; }
        }
      `}</style>
