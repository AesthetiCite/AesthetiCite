...
export function SafetyEscalationBlock({
  ...
  return (
    <Card
      className={`${cfg.cardBorder} border-2 ${className}`}
      role="region"
      aria-label="Safety and escalation"
      data-testid={`card-safety-${safety.risk_level}`}
    >
      {/* Header */}
      <CardHeader
        ...
        <CardContent className="px-4 pb-4 pt-3 space-y-4">
          ...
          {safety.escalation_criteria?.length > 1 && (
            <div>
              ...
              <BulletList items={safety.escalation_criteria} icon={ChevronRight} />
            </div>
          )}
          ...
          {safety.medico_legal && (
            <div className="border-t pt-3">
              <button
                ...
                data-testid="button-toggle-medico-legal"
              >
...
// ---------------------------------------------------------------------------
// Accessor — derive safety from meta payload
// ---------------------------------------------------------------------------
